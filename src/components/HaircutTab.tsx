        ...
        <div className="space-y-6 animate-in fade-in duration-700">
            <div className="glass border border-zinc-800 rounded-3xl p-6">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-white uppercase tracking-widest">Hair Profile</h3>
                        <p className="text-[10px] text-zinc-500 uppercase font-medium">Style match and quality audit</p>
                    </div>
                </div>
            ...
            <div className="glass-dark border border-zinc-800 rounded-3xl p-6 relative overflow-hidden group">
                ...
                <div className="flex items-start justify-between relative z-10">
                    <div>
                        <p className="text-[10px] font-bold text-indigo-400 uppercase tracking-[0.2em] mb-1">Face shape classification</p>
            ...
            <div className="space-y-4">
                <h5 className="text-[10px] font-bold text-zinc-500 uppercase tracking-[0.3em] pl-1">Recommended cuts</h5>
                    ...
                    {hairRecs.recommendations.map((rec, idx) => (
                        <div key={idx} className="p-5 rounded-3xl bg-zinc-900/50 border border-zinc-800 hover:border-indigo-500/30 transition-all group">
                            <div className="flex justify-between items-start mb-2">
                                ...
                                <span className="text-[9px] font-bold text-indigo-500 uppercase bg-indigo-500/10 px-2 py-0.5 rounded border border-indigo-500/20">Suggested</span>
                            </div>
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                    <div className="p-4 rounded-2xl bg-red-500/5 border border-red-500/10">
                        <h5 className="text-[10px] font-bold text-red-400 uppercase tracking-widest mb-3 flex items-center gap-2">
                            <span className="w-1 h-1 rounded-full bg-red-500" /> Avoid
                        </h5>
                    ...
                    <div className="p-4 rounded-2xl bg-emerald-500/5 border border-emerald-500/10">
                        <h5 className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest mb-3 flex items-center gap-2">
                            <span className="w-1 h-1 rounded-full bg-emerald-500" /> Styling tips
                        </h5>
                        <ul className="space-y-2">
